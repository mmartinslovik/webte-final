        ...
        <div className="container" id="instructions_container">
            ...
            <div className="row">
                <p>
                    ...
                    obdĺžnika tak, aby tvorili názov zobrazeného loga.
                </p>
                <p>
                    Keď si budete istí, že vami zadaný názov je správny, stlačte
                    tlačidlo "Odpovedaj". Pokiaľ nebudete vedieť ihneď odpovedať, môžete sa prekliknúť na ďaľšiu úlohu
                    a znovu sa vrátiť. Ponúkané sú taktiež možnosti "Nápoveda" a "Riešenie". Nápoveda vypíše informáciu na
                    ozrejmenie danej úlohy, pričom riešenie rovno usporiada písmená do poradia v akom sa majú nachádzať.
            ...
            <div className="row">
                <p>
                    Hra je vytvorená pomocou knižnice "React.js" s pomocou knižnice "react-bootstrap" a "Bootstrap" css.
